...
public class TextUI {
    ...
    public void addFlight() {
        ...
        flightControl.addFlight(depart, target, flightControl.getPlane(id));
    }
    ...
    public void printPlane(String airplaneID) {
        System.out.println(flightControl.getPlane(airplaneID).toString());
    }
}